...
/**
 * @Author: zhangch
 * @Description: 支持哨兵模式的jedis连接池
 * @Date: Created in 16:14 2016/6/7
 * @Modified By:
 */
public class JedisSentinelPool extends Pool<Jedis> {
    ...
    public static JedisSentinelPool getPool(String masterName, String sentinels) {
        return new JedisSentinelPool(masterName, sentinels, new GenericObjectPoolConfig(), Protocol.DEFAULT_TIMEOUT, MASTER, null);
    }

    public static JedisSentinelPool getPool(String masterName, String sentinels, String password) {
        return new JedisSentinelPool(masterName, sentinels, new GenericObjectPoolConfig(), Protocol.DEFAULT_TIMEOUT, MASTER, password);
    }

    public static JedisSentinelPool getPool(String masterName, String sentinels, final GenericObjectPoolConfig poolConfig) {
        return new JedisSentinelPool(masterName, sentinels, poolConfig, Protocol.DEFAULT_TIMEOUT, MASTER, null);
    }

    public static JedisSentinelPool getPool(String masterName, String sentinels, final GenericObjectPoolConfig poolConfig, String role, final int timeout) {
        return new JedisSentinelPool(masterName, sentinels, poolConfig, timeout, role, null);
    }

    public static JedisSentinelPool getPool(String masterName, String sentinels, final GenericObjectPoolConfig poolConfig, String role, final int timeout, final String password) {
        return new JedisSentinelPool(masterName, sentinels, poolConfig, timeout, role, password);
    }

    public JedisSentinelPool(String masterName, String sentinels, final GenericObjectPoolConfig poolConfig, int timeout, String role, final String password) {
