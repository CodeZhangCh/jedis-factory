...
/**
 * @Author: zhangch
 * @Description: 支持分片的哨兵模式连接池
 * @Date: Created in 16:14 2016/10/12
 * @Modified By:
 */
public class ShardedJedisSentinelPool extends Pool<ShardedJedis> {
    ...
    //创建线程池的工厂
    public static ShardedJedisSentinelPool getPool(String masterNames, String sentinels) {
        return new ShardedJedisSentinelPool(masterNames, sentinels, new GenericObjectPoolConfig(), Protocol.DEFAULT_TIMEOUT, null);
    }

    public static ShardedJedisSentinelPool getPool(String masterNames, String sentinels, String password) {
        return new ShardedJedisSentinelPool(masterNames, sentinels, new GenericObjectPoolConfig(), Protocol.DEFAULT_TIMEOUT, password);
    }

    public static ShardedJedisSentinelPool getPool(String masterNames, String sentinels, final GenericObjectPoolConfig poolConfig) {
        return new ShardedJedisSentinelPool(masterNames, sentinels, poolConfig, Protocol.DEFAULT_TIMEOUT, null);
    }

    public static ShardedJedisSentinelPool getPool(String masterNames, String sentinels, final GenericObjectPoolConfig poolConfig, final int timeout) {
        return new ShardedJedisSentinelPool(masterNames, sentinels, poolConfig, timeout, null);
    }

    public static ShardedJedisSentinelPool getPool(String masterNames, String sentinels, final GenericObjectPoolConfig poolConfig, final int timeout, final String password) {
        return new ShardedJedisSentinelPool(masterNames, sentinels, poolConfig, timeout, password);
    }

    private ShardedJedisSentinelPool(String masterNames, String sentinels, final GenericObjectPoolConfig poolConfig, int timeout, final String password) {
        ...
        Set<String> allSentinels = new HashSet<>();
    ...
    private HostAndPort toHostAndPort(List<String> getMasterAddrByNameResult) {
        ...
        String port = getMasterAddrByNameResult.get(1);
